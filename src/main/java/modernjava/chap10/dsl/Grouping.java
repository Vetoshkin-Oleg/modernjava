...
import static modernjava.chap10.dsl.Grouping.GroupingBuilder.groupOn;
...
public class Grouping {
    ...
    private static Map<Dish.Type, Map<CaloricLevel, List<Dish>>> groupDishedByTypeAndCaloricLevel3() {
        Collector<? super Dish, ?, Map<Dish.Type, Map<CaloricLevel, List<Dish>>>> c = groupOn(Grouping::getCaloricLevel).after(Dish::getType).get();
