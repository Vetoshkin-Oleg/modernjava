...
public class WorkingWithCollections {
    ...
    private static void workingWithLists() {
        ...
        referenceCodes.stream()
                .map(code -> Character.toUpperCase(code.charAt(0)) + code.substring(1)).toList()
    ...
    private static void computingOnMaps() {
        ...
        List<String> movies = friendsToMovies.computeIfAbsent(friend, k -> new ArrayList<>());
